          ...
          {course.userCourses && course.userCourses.length > 0 && (
            <Box>
              ...
              <Box sx={{ maxHeight: 300, overflowY: "auto" }}>
                {course.userCourses.map((userCourse, index: number) => (
                    ...
                    >
                      <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                        <Avatar sx={{ width: 40, height: 40 }}>
                          <Image
                            src={userCourse.user.profile?.avatarUrl || "/shared/uploads/avatar.svg"}
                ...
                {course.reviews.slice(0, 5).map((review, index: number) => (
                  <Paper key={index} sx={{ p: 2, mb: 1 }}>
                    <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
                      <Avatar sx={{ width: 40, height: 40 }}>
                        <Image
                          src={review.user?.profile?.avatarUrl || "/shared/uploads/avatar.svg"}
