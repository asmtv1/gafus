  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.errorDetails}>
        <details>
          <summary className={styles.detailsSummary}>Техническая информация</summary>
  ...
  return (
    <div className={styles.compactContainer}>
      ...
      <div className={styles.compactContent}>
        <p className={styles.compactMessage}>{getErrorMessage(error)}</p>

        <button className={styles.compactRetryButton} onClick={handleRetry} type="button">
          Повторить
        </button>
      </div>
    </div>
