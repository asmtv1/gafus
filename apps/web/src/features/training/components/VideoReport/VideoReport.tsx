  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (blob.size > maxFileSize) {
        throw new Error(
          `Размер видео (${(blob.size / 1024 / 1024).toFixed(1)}MB) превышает максимально допустимый (50MB). Попробуйте записать видео короче.`,
        );
      }
      ...
      if (error instanceof Error && error.name === "AbortError") {
        ...
        setSubmitError(
          error instanceof Error ? error.message : "Ошибка при сохранении видео отчёта",
        );
      }
    } finally {
        ...
        <CardContent>
          {isSubmitted ? (
            ...
            <Box sx={{ textAlign: "center", py: 4 }}>
              ...
              <Box sx={{ mt: 2 }}>
                <Button variant="outlined" onClick={handleReset} startIcon={<VideoCameraFront />}>
                  Записать заново
                </Button>
              </Box>
            </Box>
                  ...
                  <Box sx={{ mb: 2 }}>
                    <Typography
                      ...
                      sx={{
                        ...
                        color:
                          recordingTime >= maxRecordingTime * 0.9 ? "error.main" : "primary.main",
                      }}
                    >
              ...
              {videoSize > 0 && (
                ...
                >
                  ...
                  {videoSize > 50 * 1024 * 1024 &&
                    " ⚠️ Превышен лимит 50MB - загрузка будет заблокирована"}
                </Typography>
              )}
