...
export async function getUserPets(userId) {
    try {
        ...
        logger.error("Ошибка при получении питомцев", error);
        return [];
    }
}
/**
...
export async function createPet(userId, data) {
    try {
        ...
        logger.error("Ошибка при создании питомца", error);
 ...
 * Обновить питомца
 */
export async function updatePet(petId, userId, data) {
    ...
    if (data.heightCm !== undefined)
        updateData.heightCm = data.heightCm ?? null;
    if (data.weightKg !== undefined)
        updateData.weightKg = data.weightKg ?? null;
    ...
    try {
        ...
        logger.error("Ошибка при обновлении питомца", error);
...
export async function deletePet(petId, userId) {
    ...
    if (existingPet.photoUrl) {
        try {
            ...
            logger.error("Failed to delete photo from CDN", error);
