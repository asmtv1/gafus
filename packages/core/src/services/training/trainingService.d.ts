 ...
 */
export declare function getTrainingDays(userId: string, courseType?: string): Promise<{
    trainingDays: {
 ...
 */
export declare function getTrainingDayWithUserSteps(userId: string, courseType: string, dayOnCourseId: string, options?: {
