 ...
 */
export declare function getCourseReviews(
  courseType: string,
  userId?: string,
 ...
 */
export declare function createCourseReview(
  userId: string,
  courseType: string,
  rating: number,
  comment?: string,
 ...
 */
export declare function updateCourseReview(
  userId: string,
  reviewId: string,
  rating: number,
  comment?: string,
 ...
 * Удаляет отзыв
 */
export declare function deleteCourseReview(
  userId: string,
  reviewId: string,
): Promise<ReviewActionResult>;
/**
 ...
 */
export declare function rateCourse(
  userId: string,
  courseId: string,
  rating: number,
): Promise<ReviewActionResult>;
