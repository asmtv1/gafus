 ...
 */
export async function getCourseReviews(courseType, userId) {
 ...
 */
export async function createCourseReview(userId, courseType, rating, comment) {
    // Находим курс
    const course = await prisma.course.findUnique({
        where: { type: courseType },
        select: { id: true },
 ...
 */
export async function updateCourseReview(userId, reviewId, rating, comment) {
 ...
 * Удаляет отзыв
 */
export async function deleteCourseReview(userId, reviewId) {
    const review = await prisma.courseReview.findUnique({
        where: { id: reviewId },
        select: {
            userId: true,
 ...
 */
export async function rateCourse(userId, courseId, rating) {
