 ...
 */
export async function getFavoritesCourses(userId) {
 ...
 */
export async function toggleFavoriteCourse(userId, courseId) {
 ...
 */
export async function addFavoriteCourse(userId, courseId) {
    const existing = await prisma.favoriteCourse.findUnique({
        where: {
            userId_courseId: {
                userId,
 ...
 */
export async function removeFavoriteCourse(userId, courseId) {
