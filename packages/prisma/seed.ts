  ...
  const [homeCourse, streetCourse, puppyCourse, authorCourse] = await prismaClient.$transaction([
    prismaClient.course.upsert({
      ...
      create: {
        ...
        duration: "2 недели",
        logoImg: "/uploads/shared/courses/3122311.jpg",
    ...
    prismaClient.course.upsert({
      ...
      create: {
        ...
        shortDesc: "Кратко о курсе",
        duration: "1 месяц",
        logoImg: "/uploads/shared/courses/21312123.jpeg",
    ...
    prismaClient.course.upsert({
      ...
      create: {
        ...
        shortDesc: "Кратко о курсе",
        duration: "много лет",
        logoImg: "/uploads/shared/courses/92086288.jpg",
  ...
  const [trainerCourse1, trainerCourse2] = await prismaClient.$transaction([
    prismaClient.course.create({
      data: {
        ...
        duration: "3 дня",
        logoImg: "/uploads/shared/courses/trainer1.jpg",
    ...
    prismaClient.course.create({
      data: {
        ...
        duration: "5 дней",
        logoImg: "/uploads/shared/courses/trainer2.jpg",
        equipment: "Продвинутое оборудование",
