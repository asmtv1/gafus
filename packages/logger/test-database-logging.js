  ...
  try {
    ...
    if (recentErrors.length === 0) {
      ...
      recentErrors.forEach((error, index) => {
        console.log(
          `   ${index + 1}. ${error.level.toUpperCase()}: ${error.message.substring(0, 60)}...`,
        );
