...
Существующие дашборды: `overview`, `system-metrics`, `postgres-metrics`, `services-availability`, `bullmq-queues`. redis-metrics удалён в рамках упрощения мониторинга (2026).
