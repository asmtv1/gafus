...
Аудит регистрации, авторизации, смены и восстановления пароля (список уязвимостей и план рефактора): **[docs/security/auth-security-audit.md](../security/auth-security-audit.md)**.
