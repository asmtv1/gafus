...
- ✅ Задача есть в очереди BullMQ (http://localhost:3003)
...
-- (см. [полную инструкцию](./REENGAGEMENT_TESTING.md))
```
...
Для детального тестирования см. [REENGAGEMENT_TESTING.md](./REENGAGEMENT_TESTING.md)
