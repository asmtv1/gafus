...
# Web app
if test_dockerfile "ci-cd/docker/Dockerfile-web-optimized" "web"; then
    echo "   ✅ Web app - OK"
else
    echo "   ❌ Web app - FAILED"
...
# Trainer Panel
if test_dockerfile "ci-cd/docker/Dockerfile-trainer-panel-optimized" "trainer-panel"; then
...
# Error Dashboard
if test_dockerfile "ci-cd/docker/Dockerfile-error-dashboard-optimized" "error-dashboard"; then
